...
└─────────────────────────────┘`} />
            ...
            <CodeBlock lang="jsx" file="Hero.jsx" code={`// 從原 HTML 拆出來的 Hero 元件
export function Hero({ title, subtitle, ctaLabel, onCta }) {
  return (
          ...
          <>
            ...
            <Collapse title="① Obsidian 文件規劃" meta="planning" defaultOpen>
              <ul>
                ...
                <li><strong style={{color:"var(--text-0)"}}>interaction.md</strong> — 互動規範</li>
              </ul>
            </Collapse>
            ...
            <Collapse title="③ VS Code 程式整合" meta="implement">
              <ul>
                ...
                <li>加入狀態管理：<code>useState</code> / <code>useContext</code></li>
              </ul>
            </Collapse>
...
Object.assign(window, { HomePage, PlanningPage });
