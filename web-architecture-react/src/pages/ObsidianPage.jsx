...
export function ObsidianChIndex({ chapters }) {
  return (
...
export function ObsidianChapter({ id, num, title, children }) {
  return (
...
└── assets/
    └── images/              # 圖片附件`} />
              ...
              <div className="img-wrap">
                <img src={(typeof window !== "undefined" && window.__resources && window.__resources.obsidianInstall) || "https://res.cloudinary.com/dbiirpmpy/image/upload/v1779591261/helun/web-tutorial/obsidian-install.png"} alt="Obsidian 安裝指南" />
...
pandoc input.md -o output.pdf \\
  ...
  -V mainfont="Heiti TC"`} />
            ...
            <ObsidianChapter id="ob-6" num="0-6" title="工具關係圖">
              ...
              <div className="img-wrap">
                <img src={(typeof window !== "undefined" && window.__resources && window.__resources.obsidianAiTools) || "https://res.cloudinary.com/dbiirpmpy/image/upload/v1779591498/helun/web-tutorial/obsidian_AI.png"} alt="Obsidian 與 AI 工具關係圖" />
                <div className="img-caption">Obsidian 作為知識中樞，串接各種 AI 工具</div>
              </div>

              <h3 className="sub">圖二：Obsidian × Claude Code 代理</h3>
              <div className="img-wrap">
                <img src={(typeof window !== "undefined" && window.__resources && window.__resources.obsidianClaudeCode) || "https://res.cloudinary.com/dbiirpmpy/image/upload/v1779591492/helun/web-tutorial/obsidian_claude_code.png"} alt="Obsidian 與 Claude Code 代理關係圖" />
                <div className="img-caption">Claude Code 插件作為代理，直接讀寫 Vault 的整個筆記庫</div>
              </div>

              <h3 className="sub">圖三：Obsidian × VS Code</h3>
              <div className="img-wrap">
                <img src={(typeof window !== "undefined" && window.__resources && window.__resources.obsidianVscode) || "https://res.cloudinary.com/dbiirpmpy/image/upload/v1779591560/helun/web-tutorial/obsidian_vs_code.png"} alt="Obsidian 與 VS Code 關係圖" />
